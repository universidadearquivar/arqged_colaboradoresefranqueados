...
A tela de Atividades agora conta com a opção de visualização dos fluxos em modo "Listagem", permitindo que as informações sejam exibidas de forma mais simples e organizada para o usuário logado, [clique para mais detalhes](../workflow/atividades/aba-minhas-atividades/#botao-dados-listagem).
