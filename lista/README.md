...
* **Provisória:** A lista provisória  tem o objetivo de facilitar o processo de indexação, enviando para o sistema dados do próprio documento, como por exemplo, dados de indexação de uma nota fiscal.&#x20;
