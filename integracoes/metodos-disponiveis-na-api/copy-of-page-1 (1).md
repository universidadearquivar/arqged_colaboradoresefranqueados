...
## 8.1.POST Cadastrar nota fiscal como documento: não usar este método. Usar o método POST Documento <a href="#id-7.1.post-api-notafiscal-importanotafiscal" id="id-7.1.post-api-notafiscal-importanotafiscal"></a>
