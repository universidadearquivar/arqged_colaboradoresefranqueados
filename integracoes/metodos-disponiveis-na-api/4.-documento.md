...
{% embed url="https://developers.arquivar.com/api-details#api=api-rest-arqged&operation=patch-api-documento-iddocumento-cliente-idcliente-remover-compartilhamento-a" %}
...
### URL <a href="#requisicao" id="requisicao"></a>
...
{% embed url="https://integracao.arquivar.com/v2/doc" %}
...
### GET Consultar Compartilhamento dos Arquivos de um&#xD; Documento
...
## 4.6.DELETAR link de copartilhamento dos arquivos de um documento V2 <a href="#id-4.4-delete-api-documento-delete" id="id-4.4-delete-api-documento-delete"></a>

### URL

{% embed url="https://integracao.arquivar.com/v2/doc" %}

### Nomenclatura <a href="#entrada-3" id="entrada-3"></a>
...
## 4.7.DELETE Deletar um documento de um Cliente V1 <a href="#id-4.4-delete-api-documento-delete" id="id-4.4-delete-api-documento-delete"></a>
...
## 4.8.POST Compartilhar Arquivos de um Documento V2 <a href="#id-4.4-delete-api-documento-delete" id="id-4.4-delete-api-documento-delete"></a>
