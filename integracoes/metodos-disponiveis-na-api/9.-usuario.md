...
## 10.1.POST Cadastrar um usuário V1 <a href="#id-9.1.post-api-usuario-adicionarusuario" id="id-9.1.post-api-usuario-adicionarusuario"></a>
...
## 10.2.PATCH Alterar senha de um usuário V1 <a href="#id-9.2.patch-api-usuario-idusuario-alterarsenhausuario" id="id-9.2.patch-api-usuario-idusuario-alterarsenhausuario"></a>
...
## 10.3.PATCH Alterar status de um usuário V1 <a href="#id-9.3.patch-api-usuario-idusuario-alterarstatususuario" id="id-9.3.patch-api-usuario-idusuario-alterarstatususuario"></a>
