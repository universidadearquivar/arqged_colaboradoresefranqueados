...
{% hint style="info" %}
<mark style="color:blue;">Somente é possível marcar para assinar anexos dos documentos, quando estes estiverem compartilhados (mesma regra existente no</mark> <mark style="color:blue;">**ArqGED**</mark><mark style="color:blue;">).</mark>
