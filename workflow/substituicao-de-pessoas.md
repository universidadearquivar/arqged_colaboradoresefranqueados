...
{% hint style="info" %}
Trata-se de uma substituição realizada por um período determinado, como nos casos de férias, em que há datas definidas para início e término. Ao final desse período, os novos fluxos voltam a ser direcionados ao responsável original.
{% endhint %}
