...
* Clique no Menu Perfil que fica no canto superior direito da Plataforma.
* Clique na aba Certificado digital.
* Clique no botão +
* Escolha o arquivo do Certificado ICP-Brasil tipo A1 com extensão P12 ou PFX.
* Insira um nome de identificação para o Certificado.
* Insira a senha do Certificado.
* Quando você for assinar um documento com um Certificado ICP-Brasil, basta escolher esse certificado e colocar sua a senha.
