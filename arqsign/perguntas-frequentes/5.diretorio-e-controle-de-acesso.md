# ▫️ 5.Diretório e Controle de Acesso
...
* [Estrutura de diretórios para clientes que ainda não assinaram documentos](/broken/pages/V5BYWmX1tphERtDSZJBK)
* [Estrutura de diretórios para clientes que já assinaram documentos](/broken/pages/lxQ2WT5ys9pYzLSCi0JC)

ou seguir o passo a passo descrito abaixo:

**Como Criar Estrutura de Diretórios:**&#x20;

1\. Revise as permissões dos usuários deixando somente o seu usuário como Administrador Global o que irá evitar que outros usuários acessem todas as pastas e documentos. Para isso acesse o menu [Administração > Usuários](/broken/pages/CXbsgADBiaAvvcQi3Pt9).

2\. Crie a estrutura de diretórios no menu [Processos/Pastas](/broken/pages/1lvICgMZtynvcBQaEp6G).

3\. Se você já tem documentos na pasta raiz, mova-os para as devidas pastas no menu [Processos](/broken/pages/1lvICgMZtynvcBQaEp6G).&#x20;

**Como definir Permissões de acesso aos Diretórios:**&#x20;

1\. Para facilitar, crie grupos de usuários (exemplo: por setores ou funções) no menu [Administração > Grupo de Usuários](/broken/pages/lPO7Ch3nq9VAbFVNyVqa), como no exemplo abaixo:
...
2\. Insira os grupos criados na pasta raiz e habilite permissão de leitura para todos por meio do menu [Processos > Ações](/broken/pages/1lvICgMZtynvcBQaEp6G#acoes-individuais-subdiretorios).

3\. Ajuste as permissões das pastas setoriais no menu [Processos](/broken/pages/1lvICgMZtynvcBQaEp6G) e selecione a pasta [Ações > Editar permissões; ](/broken/pages/1lvICgMZtynvcBQaEp6G#acoes-individuais-subdiretorios)
