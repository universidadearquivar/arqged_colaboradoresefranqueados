...
Para mais detalhes, [clique aqui](/broken/pages/8RfbVEhDUV99AFijVHy7).
...
Foi criado em [Integrações o menu Webhoo](/broken/pages/dIi7LvjvH9gm89jGXzEF)k. Seu objetivo é possibilitar ao cliente acompanhar o andamento dos processos de assinaturas dos documentos. Conforme a configuração de webhook, o usuário receberá os dados de execução dos processos por meio dos eventos/gatilhos.
...
* [PATCH api/v2/processo/reenviar-processo/{idProcesso}](/broken/pages/sMaSoa9NFEuZhUsX28rw)
...
Foi criado em[ Integrações o menu API](/broken/pages/5DMxFpOHQyLuQ0nIJAFU). Seu objetivo é disponibilizar ao cliente a(s) chave(s) de acesso que será(ão) utilizada(s) para gerenciamento e controle das requisições via API.
