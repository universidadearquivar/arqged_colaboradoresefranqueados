...
{% hint style="info" %}
<mark style="color:blue;">**EXEMPLO:**</mark> <mark style="color:blue;">Uma empresa possui diversas filiais e em cada uma dessas filiais existem diversos setores. Os tipos de estrutura utilizados na árvore dessa empresa seriam, por exemplo, filial, departamento e tipo de documento.</mark>
{% endhint %}
