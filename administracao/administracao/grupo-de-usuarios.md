...
A função do "Grupo de Usuários" é reunir os usuários que fazem parte de uma conta para facilitar a definição de quem pode acessar quais pastas e subpastas no menu [Processos > Pastas](/broken/pages/TZUbOrmBZQb0J2HwbmPu). As permissões de acesso para esses diretórios são definidas para grupos, e cada pessoa na conta é adicionada a um pelos administradores globais.
