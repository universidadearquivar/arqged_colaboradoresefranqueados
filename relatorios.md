...
{% hint style="danger" %}
<mark style="color:red;">Ao solicitar um relatório customizado, é importante que no chamado seja descrito com riqueza de detalhes todas as informações que devem ser consideradas em sua construção, isso ajudará em sua elaboração e no</mark> <mark style="color:red;"></mark><mark style="color:red;">**levantamento do custo do relatório (cobrança de hora técnica)**</mark><mark style="color:red;">, quando aplicável.</mark>
{% endhint %}
