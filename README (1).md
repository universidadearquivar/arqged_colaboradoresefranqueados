...
{% hint style="danger" %}
<mark style="color:red;">Consulte os detalhes de uso do "</mark>[<mark style="color:red;">Microsoft Authenticator</mark>](<README (1).md#como-utilizar-o-microsoft-authenticator>)<mark style="color:red;">” e “</mark>[<mark style="color:red;">Google Authenticator</mark>](<README (1).md#como-utilizar-o-google-authenticator>)<mark style="color:red;">”.</mark>
{% endhint %}
