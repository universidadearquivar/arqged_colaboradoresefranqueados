...
<figure><img src="../../../.gitbook/assets/image (270) (1).png" alt=""><figcaption><p>Clique na imagem para ampliar.</p></figcaption></figure>
...
{% hint style="info" %}
<mark style="color:blue;">**Exemplo:**</mark> <mark style="color:blue;">Em um fluxo configurado para ativar diariamente com TTD antes de vencer em 10 dias, a aplicação irá ativar fluxos todos os dias com os documentos que irão vencer em 10 dias.</mark>
{% endhint %}
