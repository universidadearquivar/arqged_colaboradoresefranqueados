...
No campo “Estoque” selecione o modelo de caixa que terá lançamento. Os modelos apresentados aqui devem ter sido anteriormente cadastrados na tela de [Configuração](./#configuracao).&#x20;
...
Para conferir se a movimentação foi feita com sucesso, acesse o menu [Saldo](./#saldo) e revise as informações cadastradas.
